      ...
      {!isOpen ? (
        <div className="relative top-0 left-0 h-full w-20 bg-maroon z-50 transition-sidebar rounded-r-xl">
          <ul className="flex flex-col h-full gap-2">
            ...
            <Link to="/">
              <li
                className={`text-3xl text-center px-4 py-3 m-2 text-white ${
                  isActive("/") ? "bg-blue rounded-xl" : ""
                } hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}
              >
                <MdDashboard />
              </li>
            </Link>
            ...
            <Link to="/search-books">
              <li
                className={`text-3xl text-center px-4 py-3 m-2 text-white ${
                  isActive("/search-books") ? "bg-blue rounded-xl" : ""
                } hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}
              >
                <GiBookshelf />
              </li>
            ...
            <Link to="/create-accounts">
              <li
                className={`text-3xl text-center px-4 py-3 m-2 text-white ${
                  isActive("/create-accounts") ? "bg-blue rounded-xl" : ""
                } hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}
              >
                <TbSettings />
              </li>
            ...
            <Link to="/books-issued">
              <li
                className={`text-3xl text-center px-4 py-3 m-2 text-white ${
                  isActive("/books-issued") ? "bg-blue rounded-xl" : ""
                } hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}
              >
                <LuBookDown />
              </li>
        ...
        <div className="relative top-0 left-0 h-full bg-maroon w-72 rounded-r-xl transition-sidebar">
          <ul className="flex flex-col min-h-screen gap-2">
            ...
            <Link to="/">
              <li
                className={`text-white text-base flex items-center px-4 py-3 m-2 ${
                  isActive("/") ? "bg-blue rounded-xl" : ""
                } hover:bg-white hover:text-black hover:rounded-xl cursor-pointer`}
              >
