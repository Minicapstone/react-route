  ...
  return (
    <div className="flex items-center justify-start min-h-screen bg-peach">
      ...
      <div className="bg-peach flex items-center justify-center w-1/2">
        ...
        <div className="bg-white p-8 rounded-md shadow-lg w-80" style={{ height: "90vh", width: "75vh" }}>
          ...
          <form className="space-y-12 p-6">
            ...
            <div className="relative">
              <label htmlFor="username" className="block text-base font-medium text-black mb-2 mt-10 ring-black">
                Username:
              </label>
            ...
            <div className="relative mt-4">
              <label htmlFor="password" className="block text-base font-medium text-black mb-2 mt-10">
                Password:
              </label>
